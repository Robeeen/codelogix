<?php
/**
 * codelogix functions and definitions
 *
...
function codelogix_setup() {
	/*
		...
		* If you're building a theme based on codelogix, use a find and replace
		* to change 'codelogix' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'codelogix', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'codelogix' ),
		)
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'codelogix_custom_background_args',
			array(
 ...
 */
function codelogix_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'codelogix' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'codelogix' ),
...
add_action( 'widgets_init', 'codelogix_widgets_init' );
